...
public class ControladorBarbero {
	...
	public ResponseEntity<?> notifyEveryone(@RequestBody HashMap<String,Object>data){
		...
		new SendManyMails(recipients,((String)data.get("subject")),((String)data.get("bodyMessage")));
		return null; 
	}
