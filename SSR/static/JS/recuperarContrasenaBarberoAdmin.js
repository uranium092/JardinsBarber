$(document).ready(function(){
    $("form").submit(function(e){
        ...
        body.passwordBarber=$("#contra").val();
        fetch("http://3.144.244.103/barbero/actualizarBarberoSinFoto", { headers:{'Content-Type':"application/json"}, method:"PUT" , body: JSON.stringify(body)}).then(()=>{
            runMessageOk(body.emailBarber);
        });
